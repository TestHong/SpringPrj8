...
<body id="page-top">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="<c:url value='/review-board/list'/>">BOARD</a>
          </li>
         ...
         <c:if test="${login != null}" >
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="/users/mypage_change_pw.jsp">MYPAGE</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="/ggbro/logout" onclick="return confirm('진짜로 로그아웃 하는거에요?')">LOGOUT</a>
          </li>
          </c:if>
        </ul>
      </div>
  ...
  <header class="masthead">
    ...
    <c:if test="${login != null}" >
    	 <a class="btn btn-chu btn-xl text-uppercase js-scroll-trigger" href="#">${login.nickname}님 안녕~♥</a>
    </c:if>
      </div>
    </div>
  </header>
